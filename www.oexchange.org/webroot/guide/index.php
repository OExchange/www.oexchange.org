...
<p>
This'll help you get up and running, whether you're a <a href="#services">service</a> that can accept content, a <a href="#sites">site</a> that has content to share, or a <a href="#tools">tool</a> of some sort.  Remember that OExchange isn't limited to "sharing" things; it applies to any case where one service wants to send URL-based content to another -- microblogging, translating, printing, whatever.
</p>
...
<p>
	<b>TIP:</b> Use the <a href="/tools/sourceharness/">Offer Test Harness</a> to test your endpoint.
</p>
