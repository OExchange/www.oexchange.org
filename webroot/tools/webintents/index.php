...
?>
	...
	<p>
		<a href="http://www.webintents.org">Web Intents</a> is an open specification being developed by several in the user-agent community, with support of those in the sharing community (like us).  From the webintents.org site:
	</p>
	<p><i>	
    ...
    <div class="grid_5 omega">
        <h3 class="bigger mb5"><a href="sender.php">Share Intent Harness</a></h3>
        <p>
